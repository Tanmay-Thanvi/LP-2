...
rules = {
    'greeting': {
        ...
        'responses': ['Hi there! How can I assist you with your order?']
    },
    'menu': {
    ...
    'food items' : {
        'patterns' : [r'Vada Pav',r'Pav Bhaji',r'Chai',r'Maggi',r'VadaPav',r'PavBhaji', ],
    ...
    'confirm_order': {
        'patterns': [r'confirm', r'place order', r'yes',r'yeah'],
    ...
    'Services': {
        'patterns': [r'help',r'support',r'service'],
        'responses': ['Hey there ! \n I can assist you in following sections.\n 1. Providing Menu \n 2. Placing order \n 3. Confirming Order \n 4. Customize Order \n 5. Cancel Order ']
    },
    'gratitude' : {
        'patterns' : [r'thank you','thank','thanks'],
...
def chat():
    ...
    print("Chatbot: I can assist you in following sections.\n 1. Providing Menu \n 2. Placing order \n 3. Confirming Order \n 4. Customize Order \n 5. Cancel Order ")
    while True:
